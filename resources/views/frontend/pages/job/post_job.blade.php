...
{!! Html::style('frontend-style/css/postajob.css') !!}
...
<div class="form-group">
  ...
  <input type="text" class="form-control"  name="name" style="height: 31px;
font-size: 12px;" id="exampleInputEmail1">
     @if($errors->has('name'))
  ...
  <div class="form-group">
    ...
    <input type="text" name="company_title" style="height: 31px;
font-size: 12px;" class="form-control" id="exampleInputPassword1">
...
<div class="form-group">
    ...
    <select class="selectpicker form-control" style="height: 31px;
font-size: 12px;" data-show-subtext="true" data-live-search="true" name="category_id">
...
<div class="form-group">
    <label for="exampleInputEmail1">Location</label> <br>
     <select class="selectpicker form-control" style="height: 31px;
font-size: 12px;" data-show-subtext="true" data-live-search="true" name="location_name">
...
@endforeach
  ...
  <div class="form-group">
    ...
    <input type="email" name="email" class="form-control" style="height: 31px;
font-size: 12px;" id="exampleInputPassword1">
     @if($errors->has('email'))
...
<label class="radio-inline">
 ...
 <div class="form-group one-range">
    ...
    <div class="input-group">
      ...
      <input type="text" name="salary1" style="height: 31px;
font-size: 12px;" class="form-control salary_value_empty" placeholder="e.g. 40, 000.00">
...
<a id="add-range" class="add_field_button" ><i class="fa fa-plus-circle" aria-hidden="true"></i>Add Salary Range</a>
  ...
  <div class="form-group salary-range">
    ...
    <div class="input-group">
      <div class="input-group-addon">$</div>
      <input type="text" name="salary2" style="height: 31px;
font-size: 12px;" class="form-control back_value_empty"  placeholder="e.g. 40, 000.00">
    ...
    <div class="input-group srange">
      ...
      <input type="text" name="salary3" style="height: 31px;
font-size: 12px;" class="form-control back_value_empty"  placeholder="e.g. 70, 000.00">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" style="height: 31px;font-size: 12px; width: 31% !important" id="datepicker" name="dedline">
