    ...
    <label>
     ...
     @endforeach         
        ...
        <li >
         ...
         <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range1">Up to 10,000Tk
    </label>
  </div>
  </li>
      <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range2">10,000tk - 20,000tk
    </label>
  </div>
  </li>  
                  <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range3">20,000tk - 30,000tk
    </label>
  </div>
  </li>     
  <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range4">30,001tk - 40,000tk
    </label>
  </div>
  </li>   
  <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range5">40,001tk - 50,000tk
    </label>
  </div>
  </li>   
     <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range6">50,001tk - 70,000tk
    </label>
  </div>
  </li>  
  <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range7">70,001tk Over
    </label>
  </div>
  </li>    
     </ul>
