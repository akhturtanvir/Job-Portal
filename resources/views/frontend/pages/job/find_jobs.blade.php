...
@endforeach
  ...
  <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range4">30,000tk - 4,0000tk
    </label>
  </div>
  </li>   
  <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range5">40,000tk - 50,000tk
    </label>
  </div>
  </li>   
  <li> <div class="checkbox">
   ...
   <li> <div class="checkbox">
    <label>
      <input type="checkbox" name="salary[]" value="range7">Over 70000tk
    </label>
  </div>
  </li>      
     </ul>
