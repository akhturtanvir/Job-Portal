 <!-- Sidebar user panel -->
   ...
   <li class="treeview">
          <a href="#">
            ...
            <span>Carrier Advice</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('advice.create')}}"><i class="fa fa-circle-o"></i>new Posts</a></li>
            <li>
            <a href="{{ route('advice.index') }}">
 ...
 <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('admin/allusers') }}"><i class="fa fa-circle-o"></i>All User</a></li>
            <li>
